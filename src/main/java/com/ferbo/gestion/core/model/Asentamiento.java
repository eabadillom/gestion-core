...
@NamedQueries({
    ...
    @NamedQuery(name = "Asentamiento.findAsentamiento", query = "SELECT a FROM Asentamiento a WHERE a.asentamientoPK.ciudad.ciudadPK.municipio.municipioPK.estado.estadoPK.pais.id = :idPais and a.asentamientoPK.ciudad.ciudadPK.municipio.municipioPK.estado.estadoPK.id = :idEstado and a.asentamientoPK.ciudad.ciudadPK.municipio.municipioPK.id = :idMunicipio and a.asentamientoPK.ciudad.ciudadPK.id = :idCiudad and a.asentamientoPK.id =:idAsentamiento"),
