    ...
    public List<ConstanciaFacturaDs> buscarNoFacturados(Integer idCliente) 
    {
        return JpaExecutor.executeRead(em -> {
            ...
            for (ConstanciaServicio constancia : listaConstancias) {
                List<ConstanciaServicioDetalle> allConstanciaServicioDetalle = constancia.getServicios();//recuperando constancias de servicio detalle de servicio ds
                List<PartidaServicio> allPartidaServicio = constancia.getPartidas();
